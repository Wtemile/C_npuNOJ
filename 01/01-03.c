...
int main()
{
    ...
    {
        printf("%zu,%d,%d",sizeof(unsigned char),0,UCHAR_MAX);
    }
    else if (a==3)
    {
        printf("%zu,%d,%d",sizeof(short),SHRT_MIN,SHRT_MAX);
    }
    else if (a==4)
    {
    ...
    {
        printf("%zu,%lld,%lld",sizeof(long long),LONG_LONG_MIN,LONG_LONG_MAX);
    }
    else if (a==10)
    {
        printf("%zu,%d,%llu",sizeof(unsigned long long),0,ULONG_LONG_MAX);
    }
